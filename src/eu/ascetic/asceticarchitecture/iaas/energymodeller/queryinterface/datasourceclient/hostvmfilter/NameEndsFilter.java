...
import static eu.ascetic.asceticarchitecture.iaas.energymodeller.queryinterface.datasourceclient.hostvmfilter.NameBeginsFilter.CONFIG_FILE;
...
public class NameEndsFilter implements ZabbixHostVMFilter {
    ...
    public NameEndsFilter() {
        try {
            ...
            ends = config.getString("iaas.energy.modeller.filter.begins", ends);
            config.setProperty("iaas.energy.modeller.filter.begins", ends);
